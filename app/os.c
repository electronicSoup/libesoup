...
result_t (*timer_start)(uint16_t, expiry_function, union sigval, es_timer *);
...
result_t (*get_io_address)(uint8_t *);
...
void os_init(void)
{
	timer_start = (result_t(*)(uint16_t, expiry_function, union sigval data, es_timer *))OS_FNS;
	timer_cancel = (result_t(*)(es_timer *))(OS_FNS + 4);

	eeprom_read = (result_t(*)(uint16_t, uint8_t *))(OS_FNS + 8);
	eeprom_write = (result_t(*)(uint16_t, uint8_t))(OS_FNS + 12);

	can_l2_tx_frame = (result_t(*)(can_frame *))(OS_FNS + 16);
	can_l2_dispatch_reg_handler = (result_t(*)(can_l2_target_t *))(OS_FNS + 20);
	can_l2_dispatch_unreg_handler = (result_t(*)(uint8_t))(OS_FNS + 24);
	can_l2_dispatch_set_unhandled_handler = (result_t(*)(can_l2_frame_handler_t handler))(OS_FNS + 28);

	dcncp_get_node_address = (uint8_t (*)(void))(OS_FNS + 32);
	...
	iso15765_dispatch_unreg_handler = (result_t(*)(uint8_t))(OS_FNS + 44);
	...
	iso11783_dispatch_unreg_handler = (result_t (*)(uint8_t id))(OS_FNS + 60);
