...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/2124829536/main_hw_timers.p1 ${OBJECTDIR}/_ext/1030658703/clock.p1 ${OBJECTDIR}/_ext/566826655/pic24FJ256GB106.p1 ${OBJECTDIR}/_ext/566826655/pic18f2680.p1 ${OBJECTDIR}/_ext/566826655/dsPIC33EP256MU806.p1 ${OBJECTDIR}/_ext/566826655/pic18f4585.p1 ${OBJECTDIR}/_ext/1924324082/hw_timers.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/2124829536/main_hw_timers.p1.d ${OBJECTDIR}/_ext/1030658703/clock.p1.d ${OBJECTDIR}/_ext/566826655/pic24FJ256GB106.p1.d ${OBJECTDIR}/_ext/566826655/pic18f2680.p1.d ${OBJECTDIR}/_ext/566826655/dsPIC33EP256MU806.p1.d ${OBJECTDIR}/_ext/566826655/pic18f4585.p1.d ${OBJECTDIR}/_ext/1924324082/hw_timers.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/2124829536/main_hw_timers.p1 ${OBJECTDIR}/_ext/1030658703/clock.p1 ${OBJECTDIR}/_ext/566826655/pic24FJ256GB106.p1 ${OBJECTDIR}/_ext/566826655/pic18f2680.p1 ${OBJECTDIR}/_ext/566826655/dsPIC33EP256MU806.p1 ${OBJECTDIR}/_ext/566826655/pic18f4585.p1 ${OBJECTDIR}/_ext/1924324082/hw_timers.p1
...
dist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -DMCP -P -N255 -I"." -I"../../../../../" --warn=-3 --asmlist -DXPRJ_PIC18F4585=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-bd30-bfff --ram=default,-cf4-cff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -DMCP -P -N255 -I"." -I"../../../../../" --warn=-3 --asmlist -DXPRJ_PIC18F4585=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/HW_Timers.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
