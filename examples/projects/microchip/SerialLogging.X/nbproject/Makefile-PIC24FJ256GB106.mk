...
SOURCEFILES_QUOTED_IF_SPACED=../../../main_serial_logging.c ../../../../utils/clock.c ../../../../logger/serial_log.c ../../../../processors/pic24FJ256GB106.c ../../../../processors/pic18f2680.c ../../../../processors/dsPIC33EP256MU806.c ../../../../processors/pic18f4585.c ../../../../comms/uart/uart.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/2124829536/main_serial_logging.o ${OBJECTDIR}/_ext/1030658703/clock.o ${OBJECTDIR}/_ext/2146973904/serial_log.o ${OBJECTDIR}/_ext/566826655/pic24FJ256GB106.o ${OBJECTDIR}/_ext/566826655/pic18f2680.o ${OBJECTDIR}/_ext/566826655/dsPIC33EP256MU806.o ${OBJECTDIR}/_ext/566826655/pic18f4585.o ${OBJECTDIR}/_ext/252781366/uart.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d ${OBJECTDIR}/_ext/1030658703/clock.o.d ${OBJECTDIR}/_ext/2146973904/serial_log.o.d ${OBJECTDIR}/_ext/566826655/pic24FJ256GB106.o.d ${OBJECTDIR}/_ext/566826655/pic18f2680.o.d ${OBJECTDIR}/_ext/566826655/dsPIC33EP256MU806.o.d ${OBJECTDIR}/_ext/566826655/pic18f4585.o.d ${OBJECTDIR}/_ext/252781366/uart.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/2124829536/main_serial_logging.o ${OBJECTDIR}/_ext/1030658703/clock.o ${OBJECTDIR}/_ext/2146973904/serial_log.o ${OBJECTDIR}/_ext/566826655/pic24FJ256GB106.o ${OBJECTDIR}/_ext/566826655/pic18f2680.o ${OBJECTDIR}/_ext/566826655/dsPIC33EP256MU806.o ${OBJECTDIR}/_ext/566826655/pic18f4585.o ${OBJECTDIR}/_ext/252781366/uart.o

# Source Files
SOURCEFILES=../../../main_serial_logging.c ../../../../utils/clock.c ../../../../logger/serial_log.c ../../../../processors/pic24FJ256GB106.c ../../../../processors/pic18f2680.c ../../../../processors/dsPIC33EP256MU806.c ../../../../processors/pic18f4585.c ../../../../comms/uart/uart.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-PIC24FJ256GB106.mk dist/${CND_CONF}/${IMAGE_TYPE}/SerialLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/2124829536/main_serial_logging.o: ../../../main_serial_logging.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2124829536" 
	@${RM} ${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d 
	@${RM} ${OBJECTDIR}/_ext/2124829536/main_serial_logging.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../../main_serial_logging.c  -o ${OBJECTDIR}/_ext/2124829536/main_serial_logging.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_PIC24FJ256GB106=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"." -I"../../../../../" -DMCP -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/2124829536/main_serial_logging.o: ../../../main_serial_logging.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d 
	@${RM} ${OBJECTDIR}/_ext/2124829536/main_serial_logging.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../../main_serial_logging.c  -o ${OBJECTDIR}/_ext/2124829536/main_serial_logging.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d"        -g -omf=elf -DXPRJ_PIC24FJ256GB106=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"." -I"../../../../../" -DMCP -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/2124829536/main_serial_logging.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/SerialLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/SerialLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -DXPRJ_PIC24FJ256GB106=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x825 -mreserve=data@0x826:0x84F   -Wl,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/SerialLogging.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/SerialLogging.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_PIC24FJ256GB106=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}/xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/SerialLogging.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
