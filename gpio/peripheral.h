...
#define PPS_I_SPI_3_CLK                   RPINR23bits.SCK3R
#define PPS_I_CSDI                        RPINR24bits.CSDIR
#define PPS_I_CSCKIN                      RPINR24bits.CSCKIN
#define PPS_I_COFSIN                      RPINR25bits.COFSR
#define PPS_I_CAN1_RX                     RPINR26bits.C1RXR
...
#define PPS_I_UART_3_RX                   RPINR27bits.U3RXR
#define PPS_I_UART_3_CTS                  RPINR27bits.U3CTSR
#define PPS_I_SPI3DI                      RPINR28bits.SDI3R 
#define PPS_I_SPI3CLK                     RPINR29bits.SCK3R
#endif
...
#elif defined(__PIC24FJ256GB106__) || defined(__PIC24FJ64GB106__)
        #define PPS_O_C1OUT                     0x01
        #define PPS_O_C2OUT                     0x02
        #define PPS_O_UART_1_TX                 0x03
        #define PPS_O_U1RTS                     0x04
        #define PPS_O_UART_2_TX                 0x05
        #define PPS_O_U2RTS                     0x06
        #define PPS_O_SPI1DO                    0x07
        #define PPS_O_SPI1CLK                   0x08
        #define PPS_O_SPI1SS                    0x09
        #define PPS_D_DCIDO                     0x0A
        #define PPS_D_DCICLK                    0x0B
        #define PPS_O_SPI2SS                    0x0C
        #define PPS_O_OC1                       0x12
        #define PPS_O_OC2                       0x13
        #define PPS_O_OC3                       0x14
        #define PPS_O_OC4                       0x15
        #define PPS_O_OC5                       0x16
        #define PPS_O_OC6                       0x17
        #define PPS_O_OC7                       0x18
        #define PPS_O_OC8                       0x19
        #define PPS_O_UART_3_TX                 0x1C
        #define PPS_O_U3RTS                     0x1D
        #define PPS_O_UART_4_TX                 0x1E
        #define PPS_O_U4RTS                     0x1F
        #define PPS_O_SPI3DO                    0x20
        #define PPS_O_SPI3CLK                   0x21
        #define PPS_O_SPI3SS                    0x22
        #define PPS_O_OC9                       0x23
        #define PPS_O_C3OUT                     0x24
#endif
